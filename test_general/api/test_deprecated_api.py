...
@pytest.mark.parametrize(
    "parameters", [
        ...
        pytest.param({"extract_image_block_types": ["[\"image\", \"table\"]"]}, id="extract_image_block_types_json"),
...
def test_form_params_passed_as_first_element_of_array_are_properly_handled(parameters: dict[str, Any]):
    """
